...
export function btnClass(variant = "primary", small = false) {
  ...
  if (variant === "success") {
    return `${ui.btn} ${size} bg-green-600 text-white hover:bg-green-700`;
  }
  if (variant === "danger") {
...
export function chipClass(active) {
  if (active) {
    return "inline-flex items-center rounded-md border-2 border-blue-800 bg-blue-700 px-3 py-2.5 text-sm font-bold text-white shadow-md ring-2 ring-blue-300 ring-offset-1 hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700";
  }
